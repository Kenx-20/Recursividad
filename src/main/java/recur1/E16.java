...
public class E16 {
    ...
    public static void main(String[] args) {
        /*Crea un método que compruebe si un número es simétrico.
        Los números simétricos son iguales a partir del dígito central
        pero comparando en dirección opuesta*/
